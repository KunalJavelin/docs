...
To implement your own checkpointer for a custom storage backend, see [Build a custom checkpointer](/oss/python/python/integrations/checkpointers/build-custom).
