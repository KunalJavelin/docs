...
- [Checkpointer integrations](/oss/python/python/integrations/checkpointers) — existing backends to reference or extend
- [Persistence concepts](/oss/python/langgraph/persistence) — full explanation of checkpoints, threads, and the writes table
