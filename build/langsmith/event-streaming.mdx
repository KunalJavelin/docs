...
- [Streaming API](/langsmith/streaming) — the legacy `stream_mode`-based streaming API. Still supported by `langgraph-api>=0.10.0rc1` for existing applications.
