...
| [Contract burndown](#contract-burndown) | **Enterprise**: Settings > Usage > Contract usage<br></br>**Self-serve**: Settings > Billing > Contract usage | Org admins only (`organization:manage`) | Enterprise only |
...
For more details on trace retention tiers, refer to [Data retention](/langsmith/observability#data-retention).
...
- [Data retention and usage limits](/langsmith/observability#data-retention)
